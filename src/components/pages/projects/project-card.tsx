...
const ProjectCard = ({ project, index }: Props) => {
    return (
        ...
        >
                ...
                <div className="flex items-center gap-4">
                    ...
                    {project.github && (
                        <a
                            ...
                            className="flex items-center gap-2 text-sm text-gray-300 border border-gray-500 px-4 py-2 rounded-full hover:text-white hover:border-gary-200 transition-colors"
                        >
                            <Image
            ...
            {/* Right: image */}
            <div className="flex items-center justify-center sm:w-60 flex-shrink-0">
                <Image
                    src={project.image}
                    alt={project.title}
                    width={240}
                    height={240}
                    className="rounded-md object-contain max-h-60 w-auto h-auto"
                />
            </div>
        </motion.div>
    );
